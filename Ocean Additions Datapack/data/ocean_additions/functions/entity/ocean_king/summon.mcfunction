particle minecraft:cloud ~ ~1 ~ 1 1 1 0.1 200 force
item replace entity @s weapon.mainhand with minecraft:air
execute positioned ~ ~-1.5 ~ run function ocean_additions:animations/ocean_king/create
function ocean_additions:entity/ocean_king/loops/root
