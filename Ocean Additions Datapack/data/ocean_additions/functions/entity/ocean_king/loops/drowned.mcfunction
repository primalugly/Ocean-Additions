execute positioned ~ ~-1.5 ~ run tp @e[type=minecraft:marker,tag=ocean_additions.ocean_king.root,limit=1,sort=nearest] ^-.3 ^ ^ ~ ~
...
execute as @e[type=slime,tag=oa.ocean_king.hurtbox,sort=nearest,limit=1] run function ocean_additions:entity/ocean_king/loops/slime
...
execute if score @s oa.timer matches 3600 run function ocean_additions:entity/ocean_king/loops/music