...
item modify entity @s armor.head ocean_additions:update_durability
execute if score #oa.temp.durability oa.fpvalue matches 0 run item replace entity @s armor.head with minecraft:air 
