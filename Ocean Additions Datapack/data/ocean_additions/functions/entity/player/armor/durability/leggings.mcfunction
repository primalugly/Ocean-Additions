...
item modify entity @s armor.legs ocean_additions:update_durability
execute if score #oa.temp.durability oa.fpvalue matches 0 run item replace entity @s armor.legs with minecraft:air 
