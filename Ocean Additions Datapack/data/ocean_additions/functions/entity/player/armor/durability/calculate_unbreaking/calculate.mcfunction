...
execute store result score #oa.temp.unbreaking_level oa.fpvalue run data get storage oa:storage root.temp.item.tag.Enchantments[{id:"minecraft:unbreaking"}]
