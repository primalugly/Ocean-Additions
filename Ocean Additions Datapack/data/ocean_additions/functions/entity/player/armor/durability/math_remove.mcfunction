...
execute unless data storage oa:storage root.temp.armor.tag.oa{damaged:1b} run data modify storage oa:storage root.temp.armor.tag.oa.damaged set value 1b