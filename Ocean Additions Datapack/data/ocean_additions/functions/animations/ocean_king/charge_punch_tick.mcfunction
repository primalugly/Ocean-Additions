...
execute if score frame kiko.data matches ..49 as @e[distance=..5,type=armor_stand,tag=kiko.bone] if score @s kiko.id = temp kiko.id run function ocean_additions:animations/ocean_king/charge_punch_search
