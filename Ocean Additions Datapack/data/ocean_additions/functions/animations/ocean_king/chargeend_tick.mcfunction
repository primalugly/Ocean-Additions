...
execute if score frame kiko.data matches ..17 as @e[distance=..5,tag=kiko.bone] if score @s kiko.id = temp kiko.id run function ocean_additions:animations/ocean_king/chargeend_search
