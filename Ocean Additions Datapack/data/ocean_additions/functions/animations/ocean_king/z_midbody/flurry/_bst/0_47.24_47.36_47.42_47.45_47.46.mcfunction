...
execute as @s[type=minecraft:armor_stand] as @e[type=minecraft:marker,tag=ocean_additions.ocean_king.root,limit=1] at @s run tag @s remove ocean_additions.r.flurry
