...
execute if score frame kiko.data matches ..47 as @e[distance=..5,type=armor_stand,tag=kiko.bone] if score @s kiko.id = temp kiko.id run function ocean_additions:animations/ocean_king/flurry_search
